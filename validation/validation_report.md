...
![Tela de Login](evidence/reuniao-apresentacao/01-tela-login.png)
*Apresentação da tela de login.*

![Tela de Cadastro](evidence/reuniao-apresentacao/02-tela-cadastro.png)
*Apresentação do formulário de cadastro de usuário.*

**Telas de Navegação Principal:**
![Tela Home](evidence/reuniao-apresentacao/03-tela-home.png)
*Demonstração da página inicial após o login.*

![Tela Adotar](evidence/reuniao-apresentacao/04-tela-adotar.png)
*Demonstração da página de listagem e filtro de pets.*

**Telas de Detalhes do Pet:**
![Detalhes do Pet 1](evidence/reuniao-apresentacao/06-tela-ver-pet-parte1.png)
*Visualização das informações principais do animal e do protetor.*

![Detalhes do Pet 2](evidence/reuniao-apresentacao/07-tela-ver-pet-parte2.png)
*Apresentação das características e história do animal.*

![Modal de Contato](evidence/reuniao-apresentacao/08-modal-contato-whatsapp.png)
*Demonstração do modal com opções de contato, incluindo WhatsApp.*

**Telas de Gerenciamento do Usuário:**
![Perfil do Usuário](evidence/reuniao-apresentacao/09-tela-perfil-usuario.png)
*Apresentação da página de perfil do protetor.*

![Editar Perfil](evidence/reuniao-apresentacao/10-tela-editar-perfil.png)
*Demonstração do formulário de edição de perfil.*

**Telas de Gerenciamento de Pets:**
![Novo Pet 1](evidence/reuniao-apresentacao/11-tela-novo-pet-parte1.png)
*Apresentação do formulário de cadastro de um novo animal (parte 1).*

![Novo Pet 2](evidence/reuniao-apresentacao/12-tela-novo-pet-parte2.png)
*Apresentação do formulário de cadastro de um novo animal (parte 2).*

**Telas de Depoimentos:**
![Deixar Depoimento](evidence/reuniao-apresentacao/13-tela-deixar-depoimento.png)
...
![Gráfico 2: Navegação](feedback/graficos-feedback/02-grafico.png)
*2. A navegação na plataforma é intuitiva?*

![Gráfico 3: Organização das Informações](feedback/graficos-feedback/03-grafico.png)
*3. As informações sobre os animais estão bem organizadas?*

![Gráfico 4: Confiança e Segurança](feedback/graficos-feedback/04-grafico.png)
*4. A plataforma transmite confiança e segurança?*

![Gráfico 5: Cadastro](feedback/graficos-feedback/05-grafico.png)
*5. O processo de cadastramento parece ser eficiente?*

![Gráfico 6: Suficiência das Informações](feedback/graficos-feedback/06-grafico.png)
*6. A plataforma oferece informações suficientes sobre cada animal?*

![Gráfico 7: Identidade Visual](feedback/graficos-feedback/07-grafico.png)
*7. A identidade visual reflete bem a proposta de adoção?*

![Gráfico 8: Localização de Elementos](feedback/graficos-feedback/08-grafico.png)
*8. É fácil localizar os elementos de interação?*

![Gráfico 9: Recomendação](feedback/graficos-feedback/09-grafico.png)
